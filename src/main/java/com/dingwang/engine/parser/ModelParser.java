 ...
 */
package com.dingwang.engine.parser;
...
import com.dingwang.engine.helper.XmlHelper;
import com.dingwang.engine.model.NodeModel;
import com.dingwang.engine.model.ProcessModel;
import com.dingwang.engine.model.TransitionModel;
 ...
 * @since 1.0
 */
public class ModelParser implements ApplicationContextAware {
    ...
    public static ProcessModel parse(byte[] bytes) {
        ...
        if (documentBuilder != null) {
            ...
            throw new RuntimeException("documentBuilder is null");
        }
    }
    ...
    private static NodeModel parseModel(Node node) {
        ...
        try {
            nodeParser = (NodeParser) applicationContext.getBean(nodeName.toLowerCase() + "Parser");
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ModelParser.applicationContext = applicationContext;
    }
}
