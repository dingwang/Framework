...
/**
 * 类PersonInHandler.java的实现描述：TODO 类实现描述
 * 
 * @author wangding_91@163.com 2016年2月22日 上午11:53:01
 */
public class PersonInHandler extends ChannelHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        System.out.println("PersonInHandler channelRead message=" + message.getName() + ">>>>>>" + message.getAge());
